          	...
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            ...
	            <p style="font-size: 18px;">Explore on a budget with our affordable car rentals. Enjoy the freedom to discover your dream destination at a low cost.</p>
	            	<div class="heading-title ml-5">
		            	<p><a href="custbook.php" class="btn btn-info py-3 px-4">START BOOKING</a></p>
	            	</div>
            </div>
          </div>
        </div>
								        ...
								        <div class="car-wrap rounded ftco-animate">
								            ...
								            <div class="text">
								                ...
								                <p class="d-flex mb-0 d-block">
								                    <a href="custbookcar.php?id=' . $row['v_reg'] . '" class="btn btn-primary py-2 mr-1">Book now</a>
								                    <a href="custcardetails.php?id=' . $row['v_reg'] . '" class="btn btn-secondary py-2 ml-1">Details</a>
								                </p>
								            </div>
								        </div>
								    </div>';
