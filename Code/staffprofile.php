      ...
      <div class="container">
        ...
        <div class="row d-flex mb-5 contact-info">
          <div class="col-md-8 block-9 mb-md-5 mx-auto">
            <form method = "POST" action="staffprofileprocess.php" class="bg-light p-5 contact-form" id="updateForm" onsubmit="return validateForm()">
              ...
              <div class="form-group">
                <a href="staffmain.php" class="btn btn-light btn-block py-3">CANCEL</a>
            </div>
