    ...
    <div class="container mt-4">
        <div class="row">
            ...
            while ($row = $result->fetch_array()) {
                ...
                echo '<div class="text">';
                echo '<h2 class="mb-0">' . $row['v_model'] . '</h2>';
                echo '<div class="d-flex mb-3">';
                echo '<span class="cat">' . $row['v_type'] . '</span>';
                echo '<p class="price ml-auto">RM' . $row['v_price'] . ' <span>/day</span></p>';
                echo '</div>';
                echo '<p class="d-flex mb-0 d-block"><a href="custbookcar.php?id='.$row['v_reg'].'" class="btn btn-primary py-2 mr-1">Book now</a> <a href="custcardetails.php?id='.$row['v_reg'].'" class="btn btn-secondary py-2 ml-1">Details</a></p>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
            }
