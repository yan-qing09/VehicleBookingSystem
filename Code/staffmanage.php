...
<section class="ftco-section contact-section">
      <div class="container">
        <div class="mb-3">
            ...
            <a href="?status=2" class="btn btn-success">Approved</a>
            <a href="?status=3" class="btn btn-danger">Rejected</a>
            <a href="?status=5" class="btn btn-info">Completed</a>
            <a href="?status=4" class="btn btn-warning">Canceled</a>
        </div>
        <div class="table-responsive">
        <table id="manageinfo" class="table table-hover">
          <thead>
            <tr>
            ...
            while ($row = mysqli_fetch_array($result)) {
              echo "<script>
                        document.addEventListener('DOMContentLoaded', function () {
                            var modalId = 'updateModal-" . $row['b_id'] . "';
              ...
              echo "<td class='text-center'>";
                if ($row['b_status'] != 4 && $row['b_status'] != 5) {
                    echo "<button type='button' class='btn btn-warning m-1' id='modalTrigger-" . $row['b_id'] . "'>Update</button>&nbsp";
                }
                else {
                    echo "No Operation";
                }
              ...
              echo "<div class='modal fade' id='updateModal-" . $row['b_id'] . "' tabindex='-1' role='dialog' aria-labelledby='updateModalLabel' aria-hidden='true'>
                  <div class='modal-dialog' role='document'>
                      <div class='modal-content text-dark'>
                          <div class='modal-header'>
                              <h5 class='modal-title' id='updateModalLabel'>Booking Details</h5>
                              <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                  <span aria-hidden='true'>&times;</span>
                              </button>
                          </div>
                          <div class='modal-body'>
                              <form id='approval' method='post' action='staffupdateprocess.php?id=" . $row['b_id'] . "'>";
                                   echo "<div class='row'>
                                            <div class='col-sm-6'>
